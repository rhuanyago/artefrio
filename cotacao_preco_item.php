                        ...
                        <section class="card card-default">
                            ...
                            <div class="card-body">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <tr style="font-size:14px;">
                                                                        ...
                                                                        <?php if($rows_cotacao['status'] == "F"){ ?>
                                                                        <td class="text-center"><input type="number" name="quantidade" id="quantidade<?php echo $item; ?>" class="form-control text-center " inputmode="numeric" value="<?php echo $rows_rsitens['quantidade'] ?>" readonly></td>
                                                                        <td class="text-center"><input type="text" name="valor_unitario" id="valor_unitario<?php echo $item; ?>"  onkeyup="valorreais(this)" value="<?php echo number_format($rows_rsitens['valor_unitario'],2,",","." ) ?>" readonly inputmode="numeric" class="form-control text-center valor" value=""></td>
                                                                        <td class="text-center"><input type="text" name="preco_total" id="preco_total<?php echo $item; ?>" value="<?php echo number_format($rows_rsitens['valor_total'],2, ",", "." ) ?>" inputmode="numeric" readonly class="form-control text-center" ></td>
                                                                        <?php }else{ ?>
                                ...
                                <div class="card-footer">
                                    <br>
                                        <a href="cotacao_finaliza_update.php?idcotacao=<?php echo $idcotacao ?>" class="btn btn-success float-right text-weight-bold text-white" style="border:none;">Finalizar Cotação <i class="fas fa-check-circle"></i></a>
                                    <br>
                                </div>
                                <?php } ?>
                            </div>
