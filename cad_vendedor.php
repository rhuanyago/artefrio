                    ...
                    <div class="col-xl-12 order-1 mb-4">
                        <section class="card card-default">
                            <header class="card-header">
                                <h2 class="card-title">Cadastro de Vendedores <i class="fas fa-user-plus"></i></h2>
                            </header>
                            <div class="card-body">
                                <form class="form-horizontal form-bordered" method="POST" action="cad_vendedor_insert.php" id="Cadastro" name="Cadastro">

                                    <div class="col-lg-12">
                                        <div class="center">
                                            <?php
                                            if (isset($_SESSION['status_cadastro_vendedor'])) :
                                            ?>
                                                <div class="alert alert-success">
                                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                    <strong>Sucesso! <?php echo $_SESSION['status_cadastro_vendedor'] ?> </strong><br>
                                                </div>
                                            <?php
                                            endif;
                                            unset($_SESSION['status_cadastro_vendedor']);
                                            ?>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-lg-1 control-label text-lg-right pt-2">Tipo</label>
                                        <div class="col-lg-2">
                                            <div class="input-group">
                                                <span class="input-group-prepend">
                                                    <span class="input-group-text">
                                                ...
                                                <select name="tipo" autocomplete="off" class="form-control" required>
                                    ...
                                    <div class="form-group row">
										<label class="col-lg-3 control-label text-lg-right pt-2">Classificação</label>
										<div class="col-lg-2">
											<div class="input-group">
												<span class="input-group-prepend">
													<span class="input-group-text">
                                        ...
                                        <label class="col-lg-1 control-label text-lg-right pt-2">Meta</label>
                                        <div class="col-lg-2">
                                            <div class="input-group">
                                                <span class="input-group-prepend">
                                                    <span class="input-group-text">
                                                ...
                                                <input type="text" onkeyup="valorreais(this);" inputmode="numeric" name="meta" id="meta" min="0" class="form-control" required>
                                            </div>
                                        </div>
									</div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="input-group">
                                                ...
                                                <input id="telefone" name="telefone" id="telefone" data-plugin-masked-input data-input-mask="(99) 99999-9999" inputmode="numeric" autocomplete="off" placeholder="(DD) 99699-1234" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>    
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="input-group">
                                                ...
                                                <input name="rg" id="rg" inputmode="numeric" autocomplete="off" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>  
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                <textarea class="form-control" name="observacao" rows="3" autocomplete="off" maxlength="150" id="textareaDefault"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                ...
                                                <input id="date" name="dtadmissao" id="dtadmissao" inputmode="numeric" data-plugin-masked-input data-input-mask="99/99/9999" value="<?php echo date('d/m/Y') ?>" class="form-control" autocomplete="off" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <label class="col-lg-3 control-label text-lg-right pt-2 ">Endereço</label>
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="endereco" id="endereco" autocomplete="off" class="form-control" required readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <label class="col-lg-3 control-label text-lg-right pt-2 ">Complemento</label>
                                        <div class="col-lg-6">
                                            <div class="input-group">
                                                <input type="text" name="complemento" maxlength="30" autocomplete="off" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <label class="col-lg-3 control-label text-lg-right pt-2 ">Número</label>
                                        <div class="col-lg-2">
                                            <div class="input-group">
                                                <input type="text" name="numero" autocomplete="off" maxlength="15" class="form-control" required >
                                            </div>
                                        </div>
                                    </div>
