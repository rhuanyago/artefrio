                        ...
                        <section class="card card-danger">
                            ...
                            <div class="card-body">
                                <div class="col-lg-12">
                                    <div class="center">
                                        <?php
                                        if (isset($_SESSION['excluir_usuarios_sucesso'])) :
                                            ?>
                                            <div class="alert alert-success">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                <strong>Sucesso! <?php echo $_SESSION['excluir_usuarios_sucesso'] ?> </strong><br>
                                            </div>
                                        <?php
                                        endif;
                                        unset($_SESSION['excluir_usuarios_sucesso']);
                                        ?>
                                    </div>
                                </div>
                                <div class="col-lg-12">
