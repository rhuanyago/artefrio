                                                            ...
                                                            <tbody>
                                                                ...
                                                                <?php while ($item <= 50) {
                                                                   ...
                                                                   // $bruto = 0;
                                                                    ...
                                                                    $sql = "SELECT c.* from tbcotacao_precos c where c.idcotacao = '$idcotacao' and c.item = '$item'  order by item  ";
                                                                    $rs_itenscot = mysqli_query($conexao, $sql);
                                                                    $rows_itenscot = mysqli_fetch_array($rs_itenscot);

                                                                ?>
                                                                    
                                                                    <tr style="font-size:14px;">
                                                                        <td><?php echo $item ?></td>
                                                                        <?php if(isset($rows_itenscot['descricao'])){ ?>
                                                                        <td class="text-left" style="width:40%;"><input type="text" autocomplete="off" name="descricao" id="descricao<?php echo $item; ?>" class="form-control text-center " value="<?php echo $rows_itenscot['descricao']?>"></td>
                                                                        <?php }else{ ?>
                                                                        <td class="text-left" style="width:40%;"><input type="text" autocomplete="off" name="descricao" id="descricao<?php echo $item; ?>" class="form-control text-center " value=""></td>
                                                                        <?php } ?>
                                                                        <td class="text-center">UNID</td>
                                                                        <?php if(isset($rows_itenscot['quantidade'])){ ?>
                                                                        <td class="text-center" style="width:10%;"><input type="number" name="quantidade" id="quantidade<?php echo $item; ?>" class="form-control text-center " inputmode="numeric" value="<?php echo $rows_itenscot['quantidade']?>"></td>
                                                                        <?php }else{ ?>
                                                                        <td class="text-center" style="width:10%;"><input type="number" name="quantidade" id="quantidade<?php echo $item; ?>" class="form-control text-center " inputmode="numeric" value=""></td>
                                                                        <?php } ?>
                                                                        <?php if(isset($rows_itenscot['valor_unitario'])){ ?>
                                                                        <td class="text-center" style="width:15%;"><input type="text" name="valor_unitario" id=""  onkeyup="valorreais(this)" inputmode="numeric" class="form-control text-center" value="<?php echo number_format($rows_itenscot['valor_unitario'],2,",","." ) ?>"></td>
                                                                        <?php }else{ ?>
                                                                        ...
                                                                        <td class="actions-hover actions-fade text-center">
                                                                            <a href="cotacao_licitacao_itens_excluir.php?idcotacao=<?php echo $idcotacao ?>&id=<?php echo $rows_itenscot['id']?>" class="btn btn-danger text-white"><i class="far fa-trash-alt"></i></a>
                                                                        </td>
                                                                        <?php }else{ ?>
                                                                            <td class="actions-hover actions-fade text-center">
                                                                                <a href="cotacao_licitacao_itens_excluir.php" class="btn btn-danger text-white"><i class="far fa-trash-alt"></i></a>
                                                                            </td>
                                                                        <?php } ?>
                                                                    </tr>
                                                                    ...
                                                                    <script language="javascript" type="text/javascript">
                                                                        ...
                                                                        $(document).ready(function() {
                                                                            ...
                                                                            var desc = $("#descricao<?php echo $item; ?>").val();
                                                                            ...
                                                                            var idcotacao = "<?php echo $idcotacao?>";
                                                                            var id = "<?php echo $item?>";
                                                                            var qtde = $("#quantidade<?php echo $item; ?>").val();
                                                                            $.ajax({
                                                                                    url: 'atualiza_valor_licitacao.php', 
                                                                                    type: 'POST',
                                                                                    data: { 
                                                                                        descricao: desc,
