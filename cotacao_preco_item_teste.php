...
$sql = "SELECT * from tbcotacao_precos c where c.idcotacao = '$idcotacao' order by item  ";
...
<body>
                ...
                <div class="row">
                    <div class="col-md-12 order-1 mb-4">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label class="control-label  text-weight-bold">Favorecido</label>
                                                    <input type="text" name="tipo" value="<?php echo $rows_cotacao['favorecido'] ?>" class="form-control" readonly />
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <tr style="font-size:14px;">
                                                                        ...
                                                                        <td class="text-center"><input type="number" name="quantidade" id="quantidade" class="form-control text-center " inputmode="numeric" value="<?php echo $rows_rsitens['quantidade'] ?>"></td>
                                                                        <td class="text-center"><input type="text" name="valor_unitario" id="valor_unitario" onkeyup="valorreais(this)"  inputmode="numeric" class="form-control text-center valor" value=""></td>
                                                                        <td class="text-center"><input type="text" name="preco_total" id="preco_total" value="0" inputmode="numeric" class="form-control text-center" ></td>
                                                                ...
                                                                <tr style="font-size:16px;">
                                                                    ...
                                                                    <td></td>
                                                                    <td class="text-center"><b><input type="text" name="total" id="total" inputmode="numeric" class="form-control text-center" value="" readonly ><b></td>
                                                                    <td></td>
                                                                </tr>
                                                            </tbody>
                                                    </table>
                        ...
                        <div class="card-footer">
                            <br>
                                <a href="cotacao_finaliza.php?idcotacao=" class="btn btn-success float-right text-weight-bold text-white" tagert="_blank" style="border:none;">Finalizar Cotação <i class="fas fa-check-circle"></i></a>
                            <br>
                        </div>
   ...
   <script language="javascript" type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var valor = $("#valor_unitario").val().replace(',','.');
        var calculo = qtd * valor;
        $("#preco_total").val(calculo.toFixed(2));
        });
    });
      ...
      <!--  $(document).ready(function (){
            $("#valor_unitario").blur(function (){
                var qtde = $("input[name='quantidade']");
                var valor_unitario = $("input[name='valor_unitario']");
                $.ajax({
                    method: "POST",
                    url: "atualiza_valor.php", // Seu servidor 
                data: {valor: valor_unitario,
                        qtde: qtde
                } // Envia o post valorInput para o servidor
                });
            });
        }); -->
    </script>
